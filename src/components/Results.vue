...
export default {
  setup() {
    ...
    const candidates = ref([
      ...
      { id: "018435", name: "Kennedy", votes: 0, photo: new URL('../assets/encoded_image_1.png', import.meta.url).href },
      { id: "019482", name: "Sonata", votes: 0, photo: new URL('../assets/encoded_image_1.png', import.meta.url).href },
      { id: "020985", name: "Michael", votes: 0, photo: new URL('../assets/encoded_image_1.png', import.meta.url).href },
      { id: "028208", name: "Enellys", votes: 0, photo: new URL('../assets/encoded_image_1.png', import.meta.url).href }
    ]);
